...
- Name: ui/planning.spec.ts >> Planning >> Schedule Activity: disabled until required fields set; success modal with Print and Done
- Location: tests/ui/planning.spec.ts:218:3
